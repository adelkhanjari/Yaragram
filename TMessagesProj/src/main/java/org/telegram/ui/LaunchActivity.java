...
import org.telegram.Adel.IdFinderActivity;
import org.telegram.Adel.LanguageActivity;
import org.telegram.Adel.MySettings.MySettingsActivity;
import org.telegram.Adel.Olds.DeleteBySelectContacts;
import org.telegram.Adel.OnlineContacts.OnlineContactsActivity;
...
public class LaunchActivity extends Activity implements ActionBarLayout.ActionBarLayoutDelegate, NotificationCenter.NotificationCenterDelegate, DialogsActivity.DialogsActivityDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!UserConfig.isClientActivated()) {
            ...
            if (Math.abs(crashed_time - System.currentTimeMillis()) >= 60 * 2 * 1000 && intent != null && !fromIntro) { // Adel
                // Adel
                if (!Setting.IsLanguageSelected()) {
        ...
        sideMenu.setOnItemClickListener(new RecyclerListView.OnItemClickListener() {
            ...
            public void onItemClick(final View view, int position) {
                ...
                if (position == 0) {
                    ...
                    drawerLayoutContainer.closeDrawer(false);
                } else if (id == 12) // Report
                {
                    Intent intent = new Intent(LaunchActivity.this, ReportActivity.class);
                    startActivity(intent);
                    drawerLayoutContainer.closeDrawer(false);
                }
                else if (id == 13) // Channel
                {
                    MessagesController.openByUserName("RosegramChannel", actionBarLayout.fragmentsStack.get(0), 0);
                    drawerLayoutContainer.closeDrawer(false);
                }
                else if (id == 14) // Theme
                {
                ...
                else if (id == 19) // ID Finder
                {
                    presentFragment(new IdFinderActivity());
                    drawerLayoutContainer.closeDrawer(false);
                }
                else if (id == 20) // Cache Cleaner
                {
                    presentFragment(new CacheControlActivity());
                    drawerLayoutContainer.closeDrawer(false);
                }
                else if (id == 21) // Delete Contacts
                {
                    presentFragment(new DeleteBySelectContacts(new Bundle()));
                    drawerLayoutContainer.closeDrawer(false);
                }
                else if (id == 22) // Online Contacts
                {
                    presentFragment(new OnlineContactsActivity(new Bundle()));
                    drawerLayoutContainer.closeDrawer(false);
                }
                else if (id == 23) // Advanced Settings
                {
